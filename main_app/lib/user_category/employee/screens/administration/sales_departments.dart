...
class SalesDepartments extends StatefulWidget {
  const SalesDepartments({super.key});

  @override
  _SalesDepartmentsState createState() => _SalesDepartmentsState();
}

class _SalesDepartmentsState extends State<SalesDepartments> {
  ...
  void _createNewGroup() {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: const Text('Новый отдел продаж'),
              ...
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Название отдела продаж',
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Новый отдел продаж создан'),
              ...
              Row(
                children: [
                  ElevatedButton.icon(
                    ...
                    label: const Text('Новый отдел продаж'),
