...
final List<Document> initialOrders = [
  Document(
    description: 'Основные правила работы в компании',
    fileName: 'Правила внутреннего трудового распорядка.pdf',
    addedBy: 'elena.volkova',
    addedDate: '2024-01-05',
    readStatus: 'Прочитан',
    filePath: '/documents/rules.pdf',
  ),
  Document(
    description: 'Документ о системе оплаты труда',
    fileName: 'Положение об оплате труда.docx',
    addedBy: 'anna.morozova',
    addedDate: '2024-01-06',
    readStatus: 'Не прочитан',
    filePath: '/documents/salary.docx',
  ),
  Document(
    description: 'Правила безопасности на рабочем месте',
    fileName: 'Инструкция по технике безопасности.pdf',
    addedBy: 'olga.lebedev',
    addedDate: '2024-01-07',
    readStatus: 'Прочитан',
    filePath: '/documents/safety.pdf',
  ),
  Document(
    ...
    readStatus: 'Не прочитан',
    filePath: '/documents/privacy.pdf',
  ),
  Document(
    description: 'Стандарты обслуживания клиентов',
    fileName: 'Регламент работы с клиентами.docx',
    addedBy: 'maria.sidorova',
    addedDate: '2024-01-09',
    readStatus: 'Прочитан',
    filePath: '/documents/clients.docx',
  ),
  Document(
    description: 'Стратегические цели и задачи',
    fileName: 'План развития компании на 2024 год.pptx',
    addedBy: 'elena.volkova',
  ...
  Document(
    description: 'Анализ продаж за последний месяц',
    fileName: 'Отчет о продажах за декабрь 2023.xlsx',
    addedBy: 'ivan.petrov',
    addedDate: '2024-01-11',
    readStatus: 'Прочитан',
    filePath: '/documents/sales.xlsx',
  ),
  Document(
    description: 'Структура подразделений компании',
    fileName: 'Схема организационной структуры.pdf',
    addedBy: 'olga.lebedev',
    addedDate: '2024-01-12',
    readStatus: 'Прочитан',
    filePath: '/documents/structure.pdf',
  ),
];
