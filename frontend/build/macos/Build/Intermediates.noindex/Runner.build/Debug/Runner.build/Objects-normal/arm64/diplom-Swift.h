...
#ifndef DIPLOM_SWIFT_H
#define DIPLOM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="diplom",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC6diplom11AppDelegate")
...
SWIFT_CLASS("_TtC6diplom17MainFlutterWindow")
